# Sanfaani Store Backend - Ticket Register

This register is the single source of truth for backend implementation tickets, resolving the historical BE-10 numbering collision.

## R1 Production-Core Blockers

| Ticket    | Domain / Scope                                                                               | Status    |
| :-------- | :------------------------------------------------------------------------------------------- | :-------- |
| **BE-10** | Customer Domain Contracts (Warranties, Claims, Returns, Support, Notifications, Procurement) | Completed |
| **BE-11** | Repair Operational Lifecycle (QC, Technician workflow, Evidence, Handover)                   | Completed |
...
## Later-Release Scope (R2 - R4)

| Ticket    | Release | Domain / Scope                                                         | Status   |
| :-------- | :------ | :--------------------------------------------------------------------- | :------- |
| **BE-29** | R2      | Mobile-facing push, deep-link, secure session, offline recovery        | Deferred |
| **BE-30** | R3      | Mature organisation accounts, recurring maintenance, service analytics | Deferred |
| **BE-31** | R4      | Advanced search, loyalty, verified reviews, courier integration        | Deferred |
